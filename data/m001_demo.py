...
absolute_technical = [
    ...
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="N6 Side Return", units="—", data_sheet_required='1 × 10" 300# RFWN, DNCM W/baffle', vendor_offer='1 × 10" 300# RFWN, DNCM W/baffle', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="N7 Reb Draw", units="—", data_sheet_required='1 × 16" 300# RFWN, DNCM', vendor_offer='1 × 16" 300# RFWN, DNCM', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="N8 Reb Return", units="—", data_sheet_required='1 × 12" 300# RFWN, DNCM W/baffle', vendor_offer='1 × 12" 300# RFWN, DNCM W/baffle', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="N9 Equalizing Line", units="—", data_sheet_required='1 × 4" 300# RFWN, DNCM', vendor_offer='1 × 4" 300# RFWN, DNCM', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="N10–N13 TE", units="—", data_sheet_required='4 × 1.5" 300# RFWN', vendor_offer='4 × 1.5" 300# RFWN', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="N14–N16 DPI", units="—", data_sheet_required='3 × 1.5" 300# RFWN', vendor_offer='3 × 1.5" 300# RFWN', compliance=ComplianceStatus.OK),
    ...
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="MW2 Manway (Dump)", units="—", data_sheet_required='4 × 10" 300# RFWN W/B&D', vendor_offer='4 × 10" 300# RFWN W/B&D', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="S1 Skirt Vent", units="—", data_sheet_required='1 × 2" PIPE', vendor_offer='2 × 2" skirt vents', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="S2 Skirt Access", units="—", data_sheet_required='2 × 18" PIPE', vendor_offer='2 × 18" skirt access', compliance=ComplianceStatus.OK),
    # INTERNALS
...
bwfs_technical = [
    ...
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="MW1 Manway (Fill)", units="—", data_sheet_required='4 × 18" 300# RFWN W/B&D (blind + davit)', vendor_offer='4 × 18" 300# RFWN W/B&D (blind + davit)', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="MW2 Manway (Dump)", units="—", data_sheet_required='4 × 10" 300# RFWN W/B&D', vendor_offer='4 × 10" 300# RFWN W/B&D', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="S1 Skirt Vent", units="—", data_sheet_required='1 × 2" PIPE', vendor_offer='Skirt vents incl (per #29); qty not specified', compliance=ComplianceStatus.OK),
    TechnicalParameter(category="NOZZLE SCHEDULE", parameter="S2 Skirt Access", units="—", data_sheet_required='2 × 18" PIPE', vendor_offer='2 × 18" skirt access (#31)', compliance=ComplianceStatus.OK),
    # INTERNALS
    TechnicalParameter(category="INTERNALS", parameter="All Internals", units="—", data_sheet_required="Free issue by client — installed by Fabricator", vendor_offer="Included", compliance=ComplianceStatus.OK),
    TechnicalParameter(category="INTERNALS", parameter="Chimney Trays", units="—", data_sheet_required="Fully welded", vendor_offer="Included", compliance=ComplianceStatus.OK),
    TechnicalParameter(category="INTERNALS", parameter="Support Rings", units="—", data_sheet_required="Installed by Fabricator", vendor_offer="Included", compliance=ComplianceStatus.OK),
